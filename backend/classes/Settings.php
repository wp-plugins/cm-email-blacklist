...
class CMEB_Settings {
    ...
    public static function getOptionsConfig() {
        ...
        'title' => 'Use White List?',
        'desc' => 'Take White List into account.'
        ),
        ...
        'category' => 'cmeb_general',
        'subcategory' => 'cmeb_general',
        'title' => 'Use Free Domain list?',
        'desc' => 'Take Free Domain list into account.'
        ),
        ...
        'type' => self::TYPE_STRING,
        'default' => 'Domain is whitelisted',
        'category' => 'cmeb_labels',
        'subcategory' => 'cmeb_labels',
        'title' => 'Domain is in the White list',
        'desc' => 'Label for \'Domain is in the white list\' message',
        ),
