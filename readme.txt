...
[youtube http://www.youtube.com/watch?v=GB5zsdQ16OQ]

> #### Plugin Site
> * [Plugin Site](https://www.cminds.com/store/purchase-cm-email-registration-blacklist-plugin-for-wordpress/)
> * [Pro Version Detailed Features List](https://www.cminds.com/store/purchase-cm-email-registration-blacklist-plugin-for-wordpress/)
...
> #### Pro Version
>
> In the Pro version we have added several methods to detect whether a domain is blacklisted in real time, 
> which means that hackers and spammers will NEVER be able to register to harm your website in any way! 
> This is done using the following detectors:
>
...
> * Define aditional errors message to show to users trying to register
...
> [More FAQ's](https://www.cminds.com/store/purchase-cm-email-registration-blacklist-plugin-for-wordpress/)
>
